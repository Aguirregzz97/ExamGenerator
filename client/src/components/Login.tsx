...
export default class Login extends React.Component<Props, State> {
    ...
    render() {
        ...
        return (
            <div>
                <NavbarC/>
                <h1 style={{ marginTop: '40px', marginBottom: '40px', color: '#244173' }} className='text-center'>Login</h1>
                <form>
                    <div className='row'>
                    ...
                    <div className='text-center'>
                        <button onClick={this.submitedLogin} className='text-center btn btn-primary'>Submit</button>
                    </div>
                </form>
            </div>
        )
